...
import com.getircase.readingisgood.application.domain.exception.AuthenticationAPIException;
...
public class JwtTokenProvider {
    ...
    @Value("${book-online-retail.app.jwt-secret}")
    private String jwtSecret;
    @Value("${book-online-retail.app.jwt-expiration-milliseconds}")
